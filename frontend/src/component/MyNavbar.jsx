...
export const MyNavbar = () => {
  ...
  const toggleslide = () => {
    ...
    document
      .getElementById("slide-profile")
      .classList.toggle("translate-y-[-100%]");
  };
  useEffect(() => {
    //ติดWarning Maximum update depth exceeded. ใครก็ได้ฝากที TT
  ...
  return (
    <>
      ...
      <div
        id="slide-profile"
        className="w-full sm:w-[250px] h-auto bg-white fixed right-0 drop-shadow-lg mt-[32px] sm:mt-[64px] p-[2em] sm:p-[1em]
      ...
      >
        ...
        <div className="relative w-full h-[40px] border-b-[0.5px] border-gray-200 flex">
          ...
          <div
            className="absolute right-0 cursor-pointer m-1"
            onClick={() => {
              toggleslide();
            }}
          >
        ...
        {!acc ? (
          <>
            ...
            <div className="mt-[0.5em] border-t-[0.5px] border-gray-400 mb-[1em]">
              <Link to={"all-books"} onClick={toggleslide}>
                <p className="text-xl cursor-pointer Gentium-B-font mt-[0.8em]">
                  Books
                </p>
              </Link>
              <Link to={"all-spaces"} onClick={toggleslide}>
                <p className="text-xl cursor-pointer Gentium-B-font mt-[0.5em]">
                  WorkSpaces
                </p>
              </Link>
            ...
            {/* Bottom of menu */}
            {/* Sign in with google */}
            <div className="w-full border-t-[0.5px] pt-3 border-gray-400 mt-[1em] sm:mt-0 flex">
              ...
              <div
                onClick={() => login()}
                className="w-[100%] h-[40px] cursor-pointer border-[0.5px] border-gray text-center"
              >
          ...
          <>
            ...
            <div className="mt-[1em]">
              ...
              <p
                className="text-lg cursor-pointer mt-[0.3em]"
                onClick={() => {
              ...
              {bookInCart.length !== 0 ? (
                ...
                >
                  Your Book Cart ({bookInCart.length})
                </p>
              ) : null}
            </div>
            <p className="text-2xl Gentium-B-font mt-[0.7em]">Navigate</p>
            ...
            <div className="w-full border-t-[0.5px] border-gray-200 mt-[1em] sm:mt-0 flex">
              <div className="relative block lg:hidden">
                ...
                {bookInCart.length !== 0 ? (
                  <div className="w-5 h-5 rounded-full bg-red-500 flex justify-center items-center absolute right-0 bottom-[-5px]">
                    <p className="text-lg text-white Gentium-B-font">
                      {bookInCart.length}
                    </p>
                  </div>
                ) : null}
              ...
              <div className="block w-full">
                ...
                <div
                  onClick={() => logout()}
                  className="mt-3 w-[100%] h-[40px] cursor-pointer border-[0.5px] border-gray text-center"
                >
      ...
      <div className="w-full fixed top-0 z-50">
        <div
          className="w-full h-10 sm:h-16 px-5 lg:px-10 drop-shadow flex justify-center
                                bg-white relative"
        >
          <div
            className="w-full
          ...
          >
            ...
            >
              <Link to={"/"} className="Gentium-B-font text-3xl cursor-pointer">
                BRAWER
              </Link>
            </div>
            {/* Nav Search Bar */}
            ...
            <div className="hidden lg:flex ml-[3em]">
              <Link to={"all-books"} className="text-2xl mr-10 cursor-pointer">
                Books
              </Link>
              <Link to={"all-spaces"} className="text-2xl mr-10 cursor-pointer">
                WorkSpaces
              </Link>
              {user.role !== "admin" ? null : (
            ...
            {/* Image Profile */}
            <div className="absolute right-[-1em] cursor-pointer hidden lg:flex">
              {!acc ? (
                ...
                <div
                  onClick={() => login()}
                  className="w-[100%] h-[40px] p-3 cursor-pointer border-[0.5px] border-gray text-center"
                >
                  <p className="mt-[-5px]">Sign in with Google 🚀</p>
                </div>
              ) : (
                // <div className="flex gap-5">
                //   <p
                //     className="mt-2 text-lg Gentium-B-font"
                //     onClick={() => {
                //       navigate("/profile");
                //     }}
                //   >
