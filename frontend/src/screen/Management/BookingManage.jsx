            ...
            <div className="bg-white p-8 rounded flex justify-center slide-down-fade">
              <div className="">
                <div className='w-full border-b-[1px] border-gray-300 relative'>
                  ...
                  <div onClick={() => { setConfirmModal(false)
                                        setConfirmText("") }} className="absolute right-0 top-0 cursor-pointer" >
            ...
            <div className="bg-white p-2 rounded flex items-center justify-center slide-down-fade">
              ...
              <div className="w-[320px] min-[768px]:w-[768px] p-5">
                ...
                <div className="flex gap-5 mt-5">
                  {/* confirm button */}
                  <div onClick={() => { setIsActiveModal(false)
                                        setConfirmModal(true)
                                        setConfirmState("Confirm") }} className='rounded cursor-pointer w-[150px] h-[50px] bg-[#2F5D62] hover:bg-[#2B5155] flex justify-center items-center'>
