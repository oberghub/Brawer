  ...
  return (
    <div>
      <div className="w-[100%] flex">
        ...
        {/* sm menu */}
        <div id="menu-slide-toggle" className="z-30 duration-300 ease-out transition-all translate-x-[-100%] invisible lg:hidden fixed left-0 md:block w-full sm:w-[320px] h-screen bg-[#FCFCFC] drop-shadow-xl pt-[6em] pl-5">
