    ...
    return (
        <>
            <div className="w-full h-screen m-auto flex relative">
                <div className="md:w-[70%] p-10 m-auto md:border-r-[1px] md:border-black">
                    ...
                    <div className="mt-5 w-full grid grid-cols-1 min-[440px]:grid-cols-2 gap-3 md:block">
                        {BookData[0].map((item, index) =>
                            <>
                                <div className="border-[1px] border-black md:flex mt-5" key={index}>
                                    <img src={require('../../local_image/book_ex.jpg')} className="w-full md:w-[180px] md:h-[220px]" alt="profile-pic" />
                ...
                <div className="w-full md:w-[500px] p-10 bg-white fixed md:static left-0 bottom-0 z-50">
                    ...
                    <div className="w-[100%] h-[50px] flex items-center justify-center bg-black mt-5">
